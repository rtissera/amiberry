...
DECLARE_MIDFUNC(mov_l_rrm_indexed_ptr(W4 d,RR4 baser, RR4 index, IMM factor));
DECLARE_MIDFUNC(mov_w_rrm_indexed_ptr(W2 d, RR4 baser, RR4 index, IMM factor));
DECLARE_MIDFUNC(mov_b_rrm_indexed_ptr(W1 d, RR4 baser, RR4 index, IMM factor));
...
DECLARE_MIDFUNC(mov_l_mrr_indexed_ptr(RR4 baser, RR4 index, IMM factor, RR4 s));
DECLARE_MIDFUNC(mov_w_mrr_indexed_ptr(RR4 baser, RR4 index, IMM factor, RR2 s));
DECLARE_MIDFUNC(mov_b_mrr_indexed_ptr(RR4 baser, RR4 index, IMM factor, RR1 s));
...
DECLARE_MIDFUNC(mov_l_rm_indexed(W4 d, MEMPTR base, RR4 index, IMM factor));
DECLARE_MIDFUNC(mov_q_rm_indexed(W4 d, MEMPTR base, RR4 index, IMM factor));
...
DECLARE_MIDFUNC(mov_l_Rr_ptr(RR4 d, RR4 s, IMM offset));
DECLARE_MIDFUNC(mov_w_Rr_ptr(RR4 d, RR2 s, IMM offset));
DECLARE_MIDFUNC(mov_b_Rr_ptr(RR4 d, RR1 s, IMM offset));
...
DECLARE_MIDFUNC(mov_q_rr(W4 d, RR4 s));
...
DECLARE_MIDFUNC(mov_q_ri(W4 d, IMM s));
...
DECLARE_MIDFUNC(and_q_ri(RW4 d, IMM i));
...
DECLARE_MIDFUNC(add_q(RW4 d, RR4 s));
...
DECLARE_MIDFUNC(add_q_ri(RW4 d, IMM i));
